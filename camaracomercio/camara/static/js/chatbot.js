const FAQ_RESPONSES = {
    ...
    afiliacion: 'Para afiliarte, completa el formulario de registro empresarial, adjunta los documentos requeridos y espera la aprobación. El proceso toma 5-7 días hábiles.',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function getBotResponse(message) {
        ...
        return 'No estoy seguro de cómo ayudarte con eso. Puedo ayudarte con información sobre: horarios, servicios, convenios, afiliación, precios, reservas, eventos, emprendimiento y contacto. ¿Sobre qué te gustaría saber?';
    }
});
