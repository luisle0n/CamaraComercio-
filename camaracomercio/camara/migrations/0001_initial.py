# Generated by Django 5.2.3 on 2025-07-20 22:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('financieros', 'Servicios Financieros'), ('turismo', 'Turismo y Hotelería'), ('profesionales', 'Servicios Profesionales'), ('graficos', 'Servicios Gráficos')], default='financieros', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representante', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('proveedor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('servicio', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='camara.servicio')),
            ],
        ),
        migrations.CreateModel(
