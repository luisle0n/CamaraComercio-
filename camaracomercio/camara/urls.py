...
urlpatterns = [
    ...
    path('admin-beneficio/<int:pk>/editar/', views.admin_beneficio_edit, name='admin_beneficio_edit'),
    path('admin-beneficio/<int:pk>/eliminar/', views.admin_beneficio_delete, name='admin_beneficio_delete'),
